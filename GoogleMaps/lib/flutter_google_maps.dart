...
import 'package:pharmagest/components/flutter_google_maps/flutter_google_maps.dart';

class FlutterGoogleMaps extends StatefulWidget {
  const FlutterGoogleMaps({Key? key}) : super(key: key);

  @override
  _FlutterGoogleMapsState createState() => _FlutterGoogleMapsState();
}

class _FlutterGoogleMapsState extends State<FlutterGoogleMaps> {
            ...
            GoogleMap.of(_key)!.addMarkerRaw(
              ...
              onInfoWindowTap: () async {
                await showDialog(
                  context: context,
                  builder: (context) => AlertDialog(
                    content: const Text('This dialog was opened by tapping on the InfoWindow!'),
                    actions: <Widget>[
                      TextButton(
                        onPressed: Navigator.of(context).pop,
                        child: const Text('CLOSE'),
          ...
          children: <Widget>[
            Positioned.fill(
              child: GoogleMap(
                ...
                markers: {
                  Marker(
                    const GeoCoord(34.0469058, -118.3503948),
                    icon: '',
                    info: '',
                    infoSnippet: '',
                    label: '',
                ...
                initialZoom: 12,
                initialPosition: const GeoCoord(34.0469058, -118.3503948), // Los Angeles, CA
                mapType: MapType.roadmap,
                mapStyle: _mapStyle ?? darkMapStyle,
                interactive: true,
                onTap: (coord) => ScaffoldMessenger.of(context).showSnackBar(SnackBar(
