...
import 'package:fluttermap/pages/map_inside_listview.dart';
import 'package:fluttermap/pages/marker_rotate.dart';
import 'package:fluttermap/pages/network_tile_provider.dart';
  ...
  return Drawer(
    child: ListView(
      children: <Widget>[
        ...
        _buildMenuItem(
            context, const Text('Map inside listview'), MapInsideListViewPage.route, currentRoute),
      ],
    ),
  );
}
