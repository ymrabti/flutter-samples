...
const String googleMapsApiKey = 'AIzaSyAtpIyXnaI7Fi6wr_FRohSP4pvONp84iBw';
    ...
    return MaterialApp(
      ...
      home: FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          return const HomePage(title: 'Ice Cream Stores in SF');
        },
      ),
      theme: ThemeData(
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    _iceCreamStores =
        FirebaseFirestore.instance.collection('ice_cream_stores').orderBy('name').snapshots();
  }
