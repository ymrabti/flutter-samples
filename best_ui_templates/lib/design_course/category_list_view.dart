import 'package:best_ui_templates/design_course/design_course_app_theme.dart';
import 'package:best_ui_templates/design_course/models/category.dart';
            ...
            if (!snapshot.hasData) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  final int count =
                      Category.categoryList.length > 10 ? 10 : Category.categoryList.length;
