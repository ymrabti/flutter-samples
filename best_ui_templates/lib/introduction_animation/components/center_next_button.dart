...
class CenterNextButton extends StatelessWidget {
  ...
  const CenterNextButton({Key? key, required this.animationController, required this.onNextClick})
      : super(key: key);
          ...
          SlideTransition(
            ...
            child: AnimatedBuilder(
              ...
              builder: (context, child) => AnimatedOpacity(
                opacity:
                    animationController.value >= 0.2 && animationController.value <= 0.6 ? 1 : 0,
